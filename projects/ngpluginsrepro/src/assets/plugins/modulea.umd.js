(function (global, factory) {
  ...
  var ModuleaService = /** @class */ (function () {
    ...
    ModuleaService.ɵprov = core.ɵɵdefineInjectable({
    ...
    ModuleaComponent = __decorate(
      [
        core.Component({
          ...
          styles: [
            "div,h1{margin:20px auto;width:60%;padding:5px;border-radius:5px;text-align:center}div.button{text-align:center}",
          ],
        }),
      ],
      ModuleaComponent
